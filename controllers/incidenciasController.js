...
function registrarIncidencia(req, res) { 
    ...
    //si pasa las dos validaciones se arma el objeto completo de la incidencia 
    const nuevaIncidencia = { id: siguienteID, empleado, area, descripcion,  prioridad: prioridad.toLowerCase(), estado: 'Pendiente' }; //toda incidencia nueva inicia como pendiente 
